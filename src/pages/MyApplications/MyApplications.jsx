...
const MyApplications = () => {
    ...
    useEffect(() => {
        // fetch(`https://job-portal-server-seven-mu.vercel.app/job-application?email=${user.email}`)
        //     .then(res => res.json())
        //     .then(data => setJobs(data))

        // axios.get(`https://job-portal-server-seven-mu.vercel.app/job-application?email=${user.email}`,
